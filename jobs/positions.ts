...
const main = async () => {
    ...
    const headers = ['account', 'equity', 'assets', 'liabilities', 'leverage', 'init_health_ratio', 'maint_health_ratio', 'instrument', 'positionSize', 'timestamp', 'position_notional_size', 'liquidation_price', 'market_per_move_to_liquidation']
