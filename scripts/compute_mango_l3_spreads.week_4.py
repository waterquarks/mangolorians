...
def main():
    ...
    db.execute("""
        insert or replace into competitors values
            ...
            ('9SrfQKierpcqo69SxPu12wPKELGCRLS3UkU1A5fcvGmn', 'BTC-PERP', 12500),
            ('8oJf4NEi6XcSgJpDTDMRdaT8yN4uqtshpQB7eJ1cBG7B', 'ETH-PERP', 12500),
            ('BBPJ9PC2HnTM3uLNiLtwukcwMDg4ejS2yfeynYKRWdWH', 'SOL-PERP', 12500),
            ('8oJf4NEi6XcSgJpDTDMRdaT8yN4uqtshpQB7eJ1cBG7B', 'AVAX-PERP', 12500),
            ('3CTtZ55HfK4VdwXn4K54W5mdwjp4rg2E28BkRohQZa9d', 'SOL-PERP', 12500),
            ('8oJf4NEi6XcSgJpDTDMRdaT8yN4uqtshpQB7eJ1cBG7B', 'SOL-PERP', 12500),
    ...
    for market, is_snapshot, orders, slot, timestamp in cur:
        ...
        for side in {'bids', 'asks'}:
            ...
            for [account, target_depth, target_spread] in (tranches.get(market) or []):
                db.execute("""
